...
#define GL_HIST_SFT_REG_INIT false
...
class Predictor {
	Traceread* trace;
	GlobalHistory GHR; // Global History Register
	vector<SaturatingCounter> SCT; // Saturating Counter Table
	int LSB_BITS;
	int GL_HIST_SFT_REG_WIDTH;
	int STCNTR_WIDTH;
	int STCNTR_TAB_SIZE;
public:
	Predictor(Traceread* trace, int ADDR_LSB_BITS, int GL_HIST_SFT_REG_WIDTH, int STCNTR_WIDTH);
	/*
